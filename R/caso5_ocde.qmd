...
# Resultados
cat("\n=== RANKING COMPLETO POR AÑO — CASO 5 (PCA/FA OCDE) ===\n")
for (a in sort(unique(df_STI_OCDE$Time))) {
  cat("\n### AÑO", a, "###\n")
  df_STI_OCDE |>
    filter(Time == a) |>
    select(uCode, Score_OCDE, Posicion) |>
    mutate(Score_OCDE = round(Score_OCDE, 3)) |>
    as_tibble() |>
    print(n = 19)
}
```
